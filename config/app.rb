...
Volt.configure do |config|
  ...
  #######################################
  config.domain = 'heroku-deployment-test.com'
  config.app_name = 'Heroku_deployment_test'
  config.mailer.from = 'Heroku_deployment_test <no-reply@heroku-deployment-test.com>'
  ...
  #
  config.app_secret = 'vJl6EskjpZQNLDPZwQCSzPRMZZE6WgDwfuiVG6l9KTKLk9GLpCxUx-Brf0hVi5qrRZQ'
  ...
  config.db_name = (config.app_name + '2_' + Volt.env.to_s)
